...
if [ "$#" -lt 1 ]; then
    ...
    color "34;5" "    exec el-node-port ..."
    color "37;1" "       - Run agora-el-node with port forwarding and user-entered parameters."
    color "34;5" "    exec cl-node ..."
    color "37;1" "       - Run agora-cl-node with user-entered parameters."
    color "34;5" "    exec cl-node-port ..."
    color "37;1" "       - Run agora-cl-node with port forwarding and user-entered parameters."
